...
const connectDB = async () => {
  try {
    ...
    const mongoURI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/prompt-refinement';
    ...
    console.error('   3. Or use MongoDB Atlas (cloud): Set MONGODB_URI in .env file');
